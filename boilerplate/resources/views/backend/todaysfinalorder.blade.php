...
@section('content')
        ...
        <div class="col-lg-6 col-xs-12">
            ...
            <div class="box box-primary" id="loading-example">
                ...
                <div class="box-header">
                    ...
                    <button type="button" class="btn btn-primary">Genrate Final</button>
    ...
    <div class="box box-danger" id="loading-example">
        <div class="box-header">
            ...
            <h3 class="box-title">Last 14 Day Table</h3>
        </div><!-- /.box-header -->
        <div class="box">
            <div class="box-body table-responsive">
                <table id="todaysfinaltable2" class="table table-bordered table-hover">
                    ...
                    <tr class="even pointer" id="1">
                        ...
                        <td class=" ">Paid</td>
                        <td class="addabove" id="1"><button>add above</button></td>
                    ...
                    <tr class="odd pointer" id="2">
                        ...
                        <td class=" ">John Blank L</td>
                        <td class=" ">Paid</td>
                        <td class="addabove" id="2"><button>add above</button></td>
                    </tr>
